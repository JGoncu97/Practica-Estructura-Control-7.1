...
public class SubMenuCicloFor {
    public static void main(String[] args) {
        ...
        for (codMenuPpal = 0; codMenuPpal != 4;) {
            ...
            switch (codMenuPpal) {
                case 1:
                    for (codMenuTipico = 0; codMenuTipico != 3;) {
                        ...
                        // Salir del bucle si se seleccionó una opción válida
                        if (codMenuTipico == 1 || codMenuTipico == 2) {
                            break;
                        }
                    }
                    break;
                ...
                case 2:
                    for (codMenuAlaCarta = 0; codMenuAlaCarta != 3;) {
                        ...
                        // Salir del bucle si se seleccionó una opción válida
                        if (codMenuAlaCarta == 1 || codMenuAlaCarta == 2) {
                            break;
                        }
                    }
                    break;
                ...
                case 3:
                    for (codMenuInternacional = 0; codMenuInternacional != 3;) {
                        ...
                        // Salir del bucle si se seleccionó una opción válida
                        if (codMenuInternacional == 1 || codMenuInternacional == 2) {
                            break;
                        }
                    }
                    break;
